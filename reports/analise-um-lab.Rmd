...
Em média, as mulheres que participaram do experimento tiveram uma associação implícita (medida pelo IAT) com a matemática **positiva** e **média** (média 0.45409043, desv. padrão 0.4670150, N = 24). Homens tiveram uma associação **positiva** com a matemática, portanto **menor** que a das mulheres (média 0.08081511, desv. padrão 0.4622496, N = 53). Houve portanto uma **alta** diferença entre homens e mulheres (diferença das médias -0.3732753, 95% CI [-0.5983056, -0.1621771]). A partir desta amostra, estimamos que...

se o intervalo inclui 0 pode ser q a diferença entre os generos seja 0 (?)
